...
namespace ASP.NetCore.Controllers
{
    public class EvaluacionController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var evaluaciones=from e in _context.Evaluaciones
            join a in _context.Alumnos on e.AlumnoId equals a.Id
            join asi in _context.Asignaturas on e.AsignaturaId equals asi.Id
